...
leaflet() %>%
  ...
  addPopups(-48.020079, -25.056311, tab_1, group = "Medidas 1",
            options = popupOptions(closeButton = FALSE)) %>%
  addPopups(-47.976391, -25.072871, tab_2, group = "Medidas 2",
            options = popupOptions(closeButton = FALSE)) %>%
  addPopups(-47.933047, -25.059032, tab_3, group = "Medidas 3",
            options = popupOptions(closeButton = FALSE)) %>%
