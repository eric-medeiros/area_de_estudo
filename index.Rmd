...
pal_green <- colorNumeric(palette = "Blues",
                         domain = 3:-3)
...
leaflet() %>%
  ...
  addPolylines(data = rota_1, group = "Área de Estudo 1", weight = 2, color = ~pal_green(Rota)) %>%
  addPolylines(data = rota_2, group = "Área de Estudo 2", weight = 2, color = ~pal_green(Rota)) %>%
  addCircleMarkers(data = pnts, group = "Área de Estudo 3", color = "blue", radius = 5) %>%
